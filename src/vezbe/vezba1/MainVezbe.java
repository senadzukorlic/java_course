...
public class MainVezbe {
    ...
    public static void main(String[] args){
        ...
        ContactManager proba = new ContactManager(contactData());
        displayContacts(proba);
        ...
        while (status.equals("continue")) {
            ...
            Contact editedContact = editedContact();
            proba.setContact(editedContact, index);
    ...
    public static Contact editedContact() {
        ...
        Contact editedContact = new Contact(name, phoneNumber, birthDate);
